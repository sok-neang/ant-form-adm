  ...
  <DetailStudent @loaded="onDataLoaded">
    ...
    <template #footer-actions="{ goBack }">
      ...
      <div class="d-flex align-items-center gap-2 flex-wrap">
        <!-- Teacher Evaluation Button -->
        <button
          type="button"
          class="btn btn-outline-primary px-4 fw-medium d-inline-flex align-items-center gap-2"
        ...
        <!-- Status Actions (Blacklist, Dropout, Fail, Pass) -->
        <button
          type="button"
