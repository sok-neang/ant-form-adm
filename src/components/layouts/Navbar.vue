                ...
                <button type="button" class="btn p-0 border-0 bg-transparent profile-btn" @click="toggleDropdown">
                    <div class="d-flex align-items-center gap-2">
                        <div class="profile-avatar position-relative">
                            <img :src="authStore.userAvatarUrl || default_avatar" alt="Profile" width="40" height="40"
                    ...
                    <div class="px-3 py-2">
                        <div class="d-flex align-items-center gap-3 px-2 py-2">
                            ...
                            <div class="flex-shrink-0">
                                <img :src="authStore.userAvatarUrl || default_avatar" alt="Avatar" width="50" height="50"
